...
export default defineConfig({
    ...
    server: {
        ...
        allowedHosts: true,
        proxy: {
            "/fast": { target: "http://127.0.0.1:8792", changeOrigin: false },
            "/v1": { target: "http://127.0.0.1:8792", changeOrigin: false },
            "/api": { target: "http://127.0.0.1:8792", changeOrigin: false },
            "/data": { target: "http://127.0.0.1:8792", changeOrigin: false },
        },
    },
    resolve: {
        alias: {
